...
public class GetProfileUsecase implements GetProfileUsecasePort {
    ...
    @Override
    public GetProfileOutput execute(Long userId) {
    ...
    private GetProfileOutput mountOutput(User user, List<UserRole> userRoles) {
        return GetProfileOutput.builder()
            ...
            .userRoles(userRoles.stream().map(GetProfileOutput.UserRoleOutput::new).toList())
            .build();
    }
}
